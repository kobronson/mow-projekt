...
\item{SpamBase (\url{http://archive.ics.uci.edu/ml/datasets/Spambase}) \\ kolekcja 4601 wiadomosci email z których większość została zaklasyfoikowana jako spam. Ostatni atrybut w zbiorze danych wskazuje czy dana wiadomość jest spamem [0,1].}
\item{} 
\end{itemize}
